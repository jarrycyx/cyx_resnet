...
LR = 0.00001
CLASS_NUM = 100
PKL_MODEL_PATH = './pklmodels/train_epoch_2000.pkl'
...
accuracy = float(np.sum([int(val_label[i]==test_y[i]) for i in range(val_label.shape[0])])) / val_label.shape[0]
