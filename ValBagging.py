...
bag_pkl_paths=["./pklmodels/bag0_epoch_20.pkl",
                "./pklmodels/bag1_epoch_20.pkl",
                "./pklmodels/bag2_epoch_20.pkl"]
...
for i, data in enumerate(validloader):
    ...
    merge_accuracy.append((val_label==merge_res).numpy())
    
    for j in range(split_res.shape[0]):
        res = split_res[j]
        split_accuracy[j].append((val_label==res).numpy())
